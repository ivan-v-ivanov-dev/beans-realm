package com.personal.additives.config;
...
import static com.personal.additives.constants.Constants.POSTGRESQL_CONNECTION_POOL;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(
        basePackages = "com.personal.additives.repository.postgres",
...
public class PostgresConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory() {
        ...
        factory.setPackagesToScan("com.personal.additives.models");
